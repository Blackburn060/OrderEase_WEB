...
function PageWaiters() {
  ...
  const fetchWaiters = async () => {
    try {
      const response = await fetch(
        "https://orderease-api.azurewebsites.net/api/listar-garcons?status=Ativo"
      );
      if (response.ok) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(
        "https://orderease-api.azurewebsites.net/api/adicionar-garcom",
        {
          method: "POST",
          headers: {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await fetch(
        `https://orderease-api.azurewebsites.net/api/atualizar-garcom/${selectedWaiter.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(
        `https://orderease-api.azurewebsites.net/api/excluir-garcom/${selectedWaiter.id}`,
        {
          method: "DELETE",
        }
      );
